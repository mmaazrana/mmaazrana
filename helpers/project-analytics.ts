...
import deepreelWebsiteLanding4 from "../public/images/projects/individual/deepreel-website/landing-4.webp"
...
import deepreelCanvaGetCredits from "../public/images/projects/individual/deepreel-canva/get-credits.webp"
import deepreelCanvaSettings from "../public/images/projects/individual/deepreel-canva/settings.webp"
import deepreelCanvaVideo from "../public/images/projects/individual/deepreel-canva/video.webp"
import deepreelCanvaVoice from "../public/images/projects/individual/deepreel-canva/voice.webp"
...
export const deepReelAI: ProjectAnalysisT = {
  ...
  detailedAnalysis: {
    ...
    requirements: [
      ...
      'Recent videos gallery with video previews and easy access to playback, share, rename and delete functionality.',
      'Avatar selection interface with gender and style filters, and clear navigation and pagination for choosing avatars.',
      'Video editor with dynamic script input area, background selection, playback controls, and video configuration options.',
      '"Asset management system" for uploaded/generated avatars and videos, with thumbnail previews and proper categorization.',
      'Guided, step-by-step, "onboarding" for creating a realistic custom talking avatar',
      'Responsive sidebar navigation for quick access to dashboard, assets, video creation, credit usage, and settings.',
      'Consistent, visually distinct call-to-action buttons - "Generate Video", "Continue", "Next".',
      'Accessibility and usability for both novice and advanced users.',
      'Secure authentication and user profile management, categorized into "individual" and "team" accounts.',
      'Amazon "AWS S3" Cloud-based storage and management for assets and videos.',
      'Dynamic "pricing plans" with monthly and annual subscription options, brieifing detailed breakdown of credits and usage.',
    ],
    keyFeatures: [
      {
        title: 'Personalized Dashboard',
        description: 'Modern, theme-adaptive dashboard with a "Get Started" section and recent video gallery for quick access to core actions and content.',
        icon: LayoutDashboard,
      },
      {
        title: 'Avatar Creation & Selection',
        description: 'Guided process for creating new "custom avatars", with a selection interface supporting "gender" and "style" filters and previewing available avatars.',
        icon: UserRoundPen,
      },
      {
        title: 'Multi-Theme Support',
        description: 'Seamless switching between "light" and "dark" modes for all major screens and workflows, with dynamic "custom illustrations" and artworks.',
        icon: SunMoon,
      },
      {
        title: 'Custom Video Generation',
        description: 'Video editor with script input, language selection, and AI-powered script generation, allowing users to generate videos with selected avatars and backgrounds.',
        icon: Video,
      },
      {
        title: 'Asset Management',
        description: 'Centralized asset library for "managing avatars" and "videos", with proper categorization, thumbnail previews, quick playback, metadata, sharing, and easy navigation.',
        icon: Clapperboard,
      },
      {
        title: 'Guided Onboarding',
        description: 'Step-by-step onboarding for users interested in creating a "realistic, custom, talking avatar", including progress indicators and detailed guidelines.',
        icon: BadgeHelp,
      },
      {
        title: 'Responsive Sidebar Navigation',
        description: 'Persistent sidebar for quick access to "dashboard", "assets", "video creation", and "settings", ensuring efficient workflow navigation.',
        icon: PanelsLeftBottom,
      },
      {
        title: 'Automated Video Generation',
        description: 'Utilization of powerful AI models to automatically generate videos with "script", "media", "captions" and music from a "link", "document", or "prompt".',
        icon: BrainCircuit,
      },
      {
        title: 'Cloud Storage Integration',
        description: 'All assets and videos are managed and stored securely in the cloud using "Amazon AWS S3", for fast and easy access.',
        icon: ServerCog,
      },
      {
        title: 'Accessibility & Usability',
        description: 'Intuitive UI/UX for both new and advanced users, with "tutorials", "user guides", "clear CTAs" and progress feedback.',
        icon: Contrast,
      },
    ],
    challenges: [
...
export const jawlineFitness: ProjectAnalysisT = {
  ...
  detailedAnalysis: {
    ...
    requirements: [
      ...
      'Structured training program organized by Levels, "Level 1 - Beginner" to "level 4 - Professional".',
      'Visual progress tracking within levels, based on the number of days completed.',
      'Intuitive exercise interface displaying "exercise name", "countdown timer", "pause/skip controls", and "upcoming exercise preview", set against an animated wave background and a "custom animation" for each exercise.',
      'Dedicated "Rest Break" screen with a timer, option to add extra time (+20 sec), set default rest time, or skip the break.',
      'Calendar-based "History" view to track completed workout days, displaying month/year and listing exercises performed on selected dates.',
      'Comprehensive "Settings" section divided into "General" - Custom Reminders, "Exercise" - Rest Duration, Voice Guide, Vibration, and "Support Us".',
      'Customizable reminder system allowing users to add multiple daily reminders with specific times and toggle activation.',
      'Clear "Day Complete" confirmation screen with an option to automatically set a reminder for the next session.',
      'Consistent bottom navigation bar for easy access to training, history, and settings.',
      'Minimalist design with clear typography, colors, and iconography suitable for a fitness app.',
    ],
    keyFeatures: [
      {
        title: 'Personalized Onboarding & Exercise Plans',
        description: 'Multi-step welcome flow collecting user "age" and "weight" to tailor exercise intensity. Workouts are structured by "level" and "day".',
        icon: LandPlot,
      },
      {
        title: 'Level-Based Progression & Tracking',
        description: 'Organized training into "Beginner", "Intermediate", "Advanced", and "Expert", Each level split into days, with a progress bar showing completion percentage for the current level.',
        icon: ListPlus,
      },
      {
        title: 'Interactive Exercise & Rest Timers',
        description: 'Displays current exercise with a "countdown timer", "pause/skip" controls, and "upcoming exercise" preview. Includes dedicated rest break screens with "timer", "skip", and "add time" options.',
        icon: Timer,
      },
      {
        title: 'Workout History Calendar',
        description: '"History" section with a "calendar view" marking completed days and listing the specific "Level/Day" exercises performed.',
        icon: CalendarHeart,
      },
      {
        title: 'Customizable Exercise Settings',
        description: 'Allows users to adjust "Rest Duration", toggle "Voice Guide" on/off, and enable/disable "Vibration" feedback.',
        icon: Star,
      },
      {
        title: 'Reminder Management',
        description: 'Users can add, view, and activate/deactivate multiple custom daily workout reminders.',
        icon: Cog,
      },
      {
        title: 'Settings Configuration',
        description: 'Centralized settings menu for "General" - Reminders, "Exercise" - Rest, Voice, Vibration, and "Support" - Rate Us.',
        icon: Wrench,
      },
      {
        title: 'Day Completion Summary',
        description: 'Confirmation screen after completing a day\'s workout, offering closure and a prompt to set the next reminder.',
...
export const equanimity: ProjectAnalysisT = {
  ...
  detailedAnalysis: {
    ...
    requirements: [
      ...
      'Fund discovery dashboard: Displays "Your Funds" and "Funds of Interest" (switchable between grid/list view) with a global "Search Query" bar. Fund cards show image, title, location, industry, market cap, min. investment, and favorite icon.',
      'Detailed fund view: Modal for "Trending Funds" or selected funds, showing title, description, location, industry, target annual return, hold period, project value, min. investment, attachments, and Q&A section, with an option to invest ("Fund" button).',
      '"Begin Your Investment Journey" onboarding form for new users: Collects Full Name, Email, Phone Number, Direct Address.',
      '"Your Chats" interface: List of contacts, message search, and standard chat messaging view.',
      '"Start a new Fund" workflow: Multi-field form for Image Upload, Title, Description, Location, Industry (dropdown), Hold Period (dropdown), Target Annual Return (dropdown), Project Value, Minimum Investment, and Document Attachments.',
      'Top navigation bar: Equanimity logo, global search, links to "Your Funds", "Funds of Interest", user profile icon, and notification icon.',
      'Responsive design for web platform accessibility across various screen sizes.',
    ],
    keyFeatures: [
      {
