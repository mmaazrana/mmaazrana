...
export const beaconTutorProject1: VideoProjectT = {
  title: 'Beacon Tutor',
  description: 'A promotional video for Beacon Tutor, showcasing their services and how they can help students.',
...
export const budsProject1: VideoProjectT = {
  title: 'Buds',
  description: 'A promotional video for Buds, showcasing their services and how they can help students.',
  fileName: 'buds-1.mp4',
  thumbnail: buds1,
};
...
export const carsDebateProject: VideoProjectT = {
  title: 'Cars Debate',
  description: 'A promotional video for Cars Debate, showcasing their services and how they can help students.',
...
export const creativerseProject: VideoProjectT = {
  title: 'Creativerse',
  description: 'A promotional video for Creativerse, showcasing their services and how they can help students.',
...
export const fireStarterProject: VideoProjectT = {
  title: 'Fire Starter',
  description: 'A promotional video for Fire Starter, showcasing their services and how they can help students.',
...
export const markazProject: VideoProjectT = {
  title: 'Markaz',
  description: 'A promotional video for Markaz, showcasing their services and how they can help students.',
  fileName: 'markaz.mp4',
  thumbnail: markaz,
};
...
export const nfcProject: VideoProjectT = {
  title: 'NFC',
  description: 'A promotional video for NFC, showcasing their services and how they can help students.',
  fileName: 'nfc.mp4',
  thumbnail: nfc,
};
...
export const nustacProject: VideoProjectT = {
  title: 'Nustac',
  description: 'A promotional video for Nustac, showcasing their services and how they can help students.',
  fileName: 'nustac.mp4',
  thumbnail: nustac,
};
...
export const phoneVideoProject: VideoProjectT = {
  title: 'Phone',
  description: 'A promotional video for Pool 515, showcasing their services and how they can help students.',
    fileName  : 'phone.mp4',
  thumbnail: phone,
    };
...
export const plutoProject: VideoProjectT = {
  title: 'Pluto',
  description: 'A promotional video for Pluto, showcasing their services and how they can help students.',
  fileName: 'pluto.mp4',
  thumbnail: pluto,
};  
