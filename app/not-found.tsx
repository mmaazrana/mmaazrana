...
function Services() {
  return (
    <div className='relative flex items-center justify-center h-[100dvh] w-[100vw] min-h-[100dvh] min-w-[100vw] overflow-hidden'>
      <div className='h-full w-full flex flex-col items-center justify-center gap-[2.5vw] lg:gap-[1.25vw] overflow-hidden'>
        <m.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          transition={{ opacity: { duration: 0.5, ease: 'linear', delay: 2 } }}
          className='flex flex-col gap-[2vw] lg:gap-[1vw] justify-end items-center basis-1/3 mb-[1vw] lg:mb-[0.5vw]'
        >
          <svg
            viewBox='0 0 24 24'
            fill='none'
            ...
            className='w-[8vw] lg:w-[4vw] h-[8vw] lg:h-[4vw] lucide lucide-unlink-icon lucide-unlink'
          >
          ...
          <div className='text-primary-hover text-center text-[2.8vw] lg:text-[1.4vw] font-[575]'>
            Aw Snap! <br />
        ...
        <svg
          ...
          className='h-[7vw] lg:h-[3.25vw]'
        >
          <m.g
            clipPath='url(#not_found_clip0_56_5)'
          ...
          />
          <defs>
            <clipPath id='not_found_clip0_56_5'>
        ...
        <m.div
          ...
          exit={{ opacity: 0 }}
          transition={{ opacity: { duration: 0.5, ease: 'linear', delay: 2 } }}
          className='flex flex-col gap-[2vw] lg:gap-[1vw] justify-start items-center basis-1/3'
        >
          ...
          <div className='relative z-10 flex flex-col justify-center items-center gap-[1vw] lg:gap-[0.5vw]'>
            <a
      ...
      <m.svg
        ...
        viewBox='0 0 100 100'
        xmlns='http://www.w3.org/2000/svg'
        className='absolute top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2 scale-230 lg:scale-100 w-[38vw] animate-[rotate_15s_linear_infinite]'
      >
        <path
          id='not_found_circlePath1'
          fill='none'
          d='
      M 10, 50
      a 40,40 0 1,1 80,0
    ...
    '
        ...
        <text>
          <textPath
            href='#not_found_circlePath1'
            className='fill-secondary uppercase text-xs leading-none tracking-[1.4] font-[50]'
          >
            Uh oh! Couldn't find your page.
          </textPath>
        </text>
      </m.svg>
      <m.svg
        ...
        viewBox='0 0 100 100'
        xmlns='http://www.w3.org/2000/svg'
        className='absolute top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2 scale-230 lg:scale-100 w-[50vw] rotate-30 animate-[rotate_20s_linear_infinite]'
      >
        <path
          id='not_found_circlePath2'
          fill='none'
          d='
      M 10, 50
      a 40,40 0 1,1 80,0
    ...
    '
        ...
        <text>
          <textPath
            href='#not_found_circlePath2'
            className='fill-secondary uppercase text-xs leading-none tracking-[1.2] font-[100]'
          >
      ...
      <m.svg
        ...
        viewBox='0 0 100 100'
        xmlns='http://www.w3.org/2000/svg'
        className='absolute top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2 scale-230 lg:scale-100 w-[64vw] rotate-60 animate-[rotate_25s_linear_infinite]'
      >
        <path
          id='not_found_circlePath3'
          fill='none'
          d='
      M 10, 50
      a 40,40 0 1,1 80,0
    ...
    '
        ...
        <text>
          <textPath
            href='#not_found_circlePath3'
            className='fill-secondary uppercase text-xs leading-none tracking-[1] font-[200]'
          >
            Uh oh! Couldn't find your page.
          </textPath>
        </text>
      ...
      <m.svg
        ...
        viewBox='0 0 100 100'
        xmlns='http://www.w3.org/2000/svg'
        className='absolute top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2 scale-230 lg:scale-100 w-[82vw] rotate-90 animate-[rotate_30s_linear_infinite]'
      >
        <path
          id='not_found_circlePath4'
          fill='none'
          d='
      M 10, 50
      a 40,40 0 1,1 80,0
    ...
    '
        ...
        <text>
          <textPath
            href='#not_found_circlePath4'
            className='fill-secondary uppercase text-xs leading-none tracking-[0.8] font-[400]'
          >
            404 Error &nbsp;404 Error&nbsp; 404 Error
          </textPath>
        </text>
      ...
      <m.svg
        ...
        viewBox='0 0 100 100'
        xmlns='http://www.w3.org/2000/svg'
        className='absolute top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2 scale-230 lg:scale-100 w-[104vw] rotate-60 animate-[rotate_35s_linear_infinite]'
      >
        <path
          id='not_found_circlePath5'
          fill='none'
          d='
      M 10, 50
      a 40,40 0 1,1 80,0
    ...
    '
        ...
        <text>
          <textPath
            href='#not_found_circlePath5'
            className='fill-secondary uppercase text-xs leading-none tracking-[0.6] font-[800]'
          >
            Uh oh! Couldn't find your page.
          </textPath>
        </text>
