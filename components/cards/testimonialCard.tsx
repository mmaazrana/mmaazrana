...
const TestimonialCard: FC<TestimonialCardProps> = React.memo(
  ({ testimonial, windowWidth, client, designation, isActive }) => {
        ...
        >
          <motion.rect
            ...
            animate={{
              ...
              strokeDasharray: `1400,${inView && isActive ? strokeDasharray[activeBreakpoint] : 3000}`,
            }}
            transition={{
            ...
            rx={
              activeBreakpoint === "md" || activeBreakpoint === "sm" ? 16 : 24
            }
