...
export default function TechnologyCard({ tech }: TechnologyCardProps) {
  ...
  return (
    <div
      ref={cardRef}
      className={`relative flex flex-col items-center justify-center rounded-xl sm:rounded-2xl md:rounded-3xl about:aspect-square hover:-translate-y-4 transition-all duration-300 group ${cardIsInView && isMobile && '-translate-y-4'}`}
    >
