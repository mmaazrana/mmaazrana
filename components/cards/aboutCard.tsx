...
const AboutCard: FC<AboutCardProps> = ({
  ...
  return (
    <div
      ...
      className={`group bg-secondary-hover-10 hover:bg-primary-invert-25 transition-colors duration-300 ease-in-out overflow-hidden relative about:shadow-frosted backdrop-blur-[2px] about:backdrop-blur-[4px] md:backdrop-blur-sm about:hover:backdrop-blur-[5px] md:hover:backdrop-blur-[6px] rounded-3xl gap-4 sm:gap-5 md:gap-6 lg:gap-7 xl:gap-8 p-8 sm:p-9 md:p-10 lg:p-11 xl:p-12 ${isActive && "backdrop-blur-[3px] !bg-primary-invert-25"}  ${className}`}
    >
      {/*<svg*/}
