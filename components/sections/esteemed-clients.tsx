...
const EsteemedClients: FC<EsteemedClientsProps> = () => {
  return (
    <>
      <div className={'flex flex-row gap-3 md:gap-4 w-full justify-between h-32'}>
      ...
      <div className={'flex flex-col justify-center items-center w-full gap-2'}>
        ...
        >
          Detail obsessed Product Designer, creating timeless and aesthetic products, helping you
          stand out over various platforms
        </Typography>
      </div>
      <div className={'flex flex-row gap-3 md:gap-4 w-full justify-between h-24'}>
