  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            className={`absolute text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl  px-0 sm:px-1 md:px-2 lg:px-3 xl:px-4 font-bold ${isEndOfPage ? "-top-1/3 opacity-100" : "top-0 opacity-0"}`}
          >
            Overview
          </div>
          <Link
        ...
        >
          <p
            className={`${isEndOfPage ? "opacity-100 w-fit -top-1/2" : "opacity-0 top-1/2 w-0"}  absolute overflow-hidden font-sans whitespace-nowrap text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl`}
          >
            Ready to create
            <br />
            something <b>Awesome?</b>
          </p>
          <motion.div
          ...
          >
            <Mail
              strokeWidth={2.5}
              className={
                "sm:min-w-[21px] md:min-w-[22px] lg:min-w-[23px] xl:min-w-[24px] "
              }
            />
            <p
              className={`${isEndOfPage ? "opacity-100 w-fit ml-2 sm:ml-3" : "w-0 opacity-0"}  overflow-hidden whitespace-nowrap font-sans text-xs sm:text-sm md:text-md lg:text-lg xl:text-xl`}
            >
              Get in Touch
            </p>
          </Link>
