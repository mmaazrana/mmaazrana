...
import { ButtonTypes, ColorTypes, Sections, TextTypes, WeightTypes } from '@/helpers/enums';
      ...
      >
              ...
              >
                ...
                >
                  <path
                    ...
                    fill="var(--primary)"
                    className={'hover:fill-primary-hover transition-all duration-300'}
                  />
                  <path
        ...
        >
          <div className={'flex flex-row justify-between items-center gap-6 w-full'}>
            ...
            >
              <Link href={''} className={`${isEndOfPage ? 'block sm:hidden' : 'hidden'}`}>
                <Button
          ...
          >
            ...
            >
              <Link href={'https://www.linkedin.com/in/mmaazrana/'} target={'_blank'}>
                <Button leftIcon={<Linkedin />} text={'Linkedin'} type={ButtonTypes.secondary} />
              </Link>
            </m.div>
            <m.div
              animate={{
            ...
            >
              <Link href={'https://www.behance.net/maazrana3'} target={'_blank'}>
                <Button leftIcon={<Behance />} text={'Behance'} type={ButtonTypes.secondary} />
              </Link>
            </m.div>
            <m.div
              animate={{
            ...
            >
              <Link href={'https://github.com/mmaazrana'} target={'_blank'}>
                <Button leftIcon={<Github />} text={'Github'} type={ButtonTypes.secondary} />
              </Link>
            </m.div>
            <m.div
              animate={{
            ...
            >
              <Link href={'https://dribbble.com/mmaazrana'} target={'_blank'}>
                <Button leftIcon={<Dribbble />} text={'Dribbble'} type={ButtonTypes.secondary} />
              </Link>
            </m.div>
          </div>
          <Link href={'mailto:awaismaaz@gmail.com'} className={'w-full hidden sm:block'}>
            <Button
              leftIcon={<Mail className={'!fill-none stroke-primary-accent'} />}
              type={ButtonTypes.primary}
