...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g fill="#4264A8" mask="url(#blenderA)">
    ...
    <g fill="#4264A8" mask="url(#blenderB)">
    ...
    <path fill="#4264A8" d="m21.165 43.001.81-.52h353.28l-.82.52H21.165Z" />
    <mask
      id="blenderE1"
      width={11}
      height={4}
    ...
    <g fill="#4264A8" mask="url(#blenderJ1)">
    ...
    />
    <path fill="#4264A8" d="m44.495 249.051.82-.52h353.27l-.81.52H44.495Z" />
    <path
      fill="var(--primary-accent)"
    ...
    <g fill="#4264A8" mask="url(#blenderM1)">
    ...
    >
      <path fill="#fff" d="m49.215 97.93-3.28-28.98h27.18l3.29 28.98h-27.19Z" />
    </mask>
    <g mask="url(#blenderJ)">
      <path
        fill="#4264A8"
    ...
    <g fill="#4264A8" fillOpacity={0.3} mask="url(#blenderN1)">
